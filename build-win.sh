...
zig 0.16.0 cc -target x86_64-windows-gnu game-*.o fltused.o -L./raylib-5.5_win64_mingw-w64/lib -lraylib -lopengl32 -lgdi32 -lwinmm -lm -lbcrypt -mwindows -o game.exe
